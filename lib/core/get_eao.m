function eao = get_eao(result_sequences, channel)
%get_eao - Description
%
% Syntax: eao = get_eao()
...
addpath('/data/home/hopeng/data/vot-toolkit'); toolkit_path; % Make sure that VOT toolkit is in the path

pwd = ['/data/home/hopeng/data/vot-toolkit/', 'vot-workspace2019', channel]  % year is a str (can not be a number)
